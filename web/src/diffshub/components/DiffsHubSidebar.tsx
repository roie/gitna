...
// Modified from the pinned DiffsHub donor: Gitna adds a Source Control tab
// while retaining the donor Files, Comments, stats and monitor surfaces.
...
type SidebarTab = 'source-control' | 'files' | 'comments';
...
export const DiffsHubSidebar = memo(function DiffsHubSidebar({
  ...
  const [activeTab, setActiveTab] = useState<SidebarTab>(
    sourceControl == null ? 'files' : 'source-control'
  );
  ...
  return (
    <>
      <button
        ...
        aria-label={sourceControl == null ? 'Close file tree' : 'Close Source Control'}
        ...
        <div className="mt-3 min-h-0 flex-1">
          {sourceControl != null && (
            <div
              ...
              hidden={activeTab !== 'source-control'}
